...
def get_limit_values(request, **kwargs):
    data_result = {}
    ...
    data = Data.objects.filter(
        measurement__name=selectedMeasure.name, time__gte=start_ts, time__lte=end_ts,
        )

    data_max = data.order_by('max_value').last()
    data_max_index = data_max.values.index(data_max.max_value)
    data_min = data.order_by('min_value').first()
    data_min_index = data_min.values.index(data_min.min_value)
    ...
    data_result["max"] = {
        ...
        selectedMeasure.name: data_max.max_value,
        "time": datetime.fromtimestamp(data_max.time / 1000000 + data_max.times[data_max_index])
        }
    data_result["min"] = {
        ...
        selectedMeasure.name: data_min.min_value,
        "time": datetime.fromtimestamp(data_min.time / 1000000 + data_min.times[data_min_index])
        }
